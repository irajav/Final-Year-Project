...
public class Prs_HomePage extends Fragment {

    public static Prs_HomePage newInstance(){
        Prs_HomePage homepage = new Prs_HomePage();
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new Prs_Fragment_Accommodation(), "Accommodation");
        adapter.addFragment(new Prs_Fragment_Attraction(), "Attraction");
        adapter.addFragment(new Prs_Fragment_Restaurant(), "Restaurant");
        adapter.addFragment(new Prs_Fragment_POI(), "Point of Interest");
