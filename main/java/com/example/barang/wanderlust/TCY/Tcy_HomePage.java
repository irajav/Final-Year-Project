...
public class Tcy_HomePage extends Fragment {

    public static Tcy_HomePage newInstance(){
        Tcy_HomePage homepage = new Tcy_HomePage();
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new Tcy_Fragment_Accommodation(), "Accommodation");
        adapter.addFragment(new Tcy_Fragment_Attraction(), "Attraction");
        adapter.addFragment(new Tcy_Fragment_Restaurant(), "Restaurant");
        adapter.addFragment(new Tcy_Fragment_POI(), "Point of Interest");
