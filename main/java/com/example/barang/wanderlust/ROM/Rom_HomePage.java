...
public class Rom_HomePage extends Fragment {

    public static Rom_HomePage newInstance(){
        Rom_HomePage homepage = new Rom_HomePage();
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new Rom_Fragment_Accommodation(), "Accommodation");
        adapter.addFragment(new Rom_Fragment_Attraction(), "Attraction");
        adapter.addFragment(new Rom_Fragment_Restaurant(), "Restaurant");
        adapter.addFragment(new Rom_Fragment_POI(), "Point of Interest");
