...
public class Brc_HomePage extends Fragment {

    public static Brc_HomePage newInstance(){
        Brc_HomePage homepage = new Brc_HomePage();
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new Brc_Fragment_Accommodation(), "Accommodation");
        adapter.addFragment(new Brc_Fragment_Attraction(), "Attraction");
        adapter.addFragment(new Brc_Fragment_Restaurant(), "Restaurant");
        adapter.addFragment(new Brc_Fragment_POI(), "Point of Interest");
